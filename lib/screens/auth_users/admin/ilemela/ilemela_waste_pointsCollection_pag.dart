...
Future<void> _submitForm() async {
  ...
  try {
    ...
    // await _firestore.collection('ilemelaWasteCollectionPoints').add(formData);
    // 6. Submit to ilemelaWasteCollectionPoints collection and get the DocumentReference
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           _buildSectionTitle('Catchment Areas'),
...
//                   label: 'Population',
//                   value: _catchmentAreas[_selectedWard]?.toString() ?? '',
//                   onChanged: (value) {
//                     if (_selectedWard != null) {
//                       setState(() {
//                         _catchmentAreas[_selectedWard!] = int.tryParse(value) ?? 0;
//                       });
//                     }
//                   },
//                 ),
...
//                 child: _buildTextField(
//                   label: 'Population',
//                   value: _catchmentAreas[_selectedStreet]?.toString() ?? '',
//                   onChanged: (value) {
//                     if (_selectedStreet != null) {
//                       setState(() {
//                         _catchmentAreas[_selectedStreet!] = int.tryParse(value) ?? 0;
//                       });
//                     }
//                   },
//                 ),
