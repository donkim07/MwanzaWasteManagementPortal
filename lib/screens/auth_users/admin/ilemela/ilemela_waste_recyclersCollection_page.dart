...
import '../mwanza/admin_management.dart';
...
class _WasteRecyclingCenterFormState extends State<WasteRecyclingCenterForm> {
  ...
  final TextEditingController _endProductImageUrlController = TextEditingController();
  // final TextEditingController _imageUrlController = TextEditingController();
  final TextEditingController _rawMaterialImageUrlController = TextEditingController();
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildResponsiveTextField(
                    label: 'Raw Material Image URL',
                    controller: _rawMaterialImageUrlController,
                    prefixIcon: Icons.link,
                    keyboardType: TextInputType.url,
                  ),
                  if (_rawMaterialImageUrlController.text.isNotEmpty) ...[
                    SizedBox(height: defaultPadding),
                    Container(
                      decoration: BoxDecoration(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(screenWidth * 0.02),
                        child: Image.network(
                         _rawMaterialImageUrlController.text,
                          height: 200,
                          width: double.infinity,
                          fit: BoxFit.cover,
                  ...
                  _buildResponsiveTextField(
                    label: 'End product Image URL',
                    controller: _endProductImageUrlController,
                    prefixIcon: Icons.link,
                    keyboardType: TextInputType.url,
                  ),
                  if (_endProductImageUrlController.text.isNotEmpty) ...[
                    SizedBox(height: defaultPadding),
                    Container(
                      decoration: BoxDecoration(
                        border: Border.all(color: Colors.grey[300]!),
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(screenWidth * 0.02),
                        child: Image.network(
                          _endProductImageUrlController.text,
                          height: 200,
                          width: double.infinity,
                          fit: BoxFit.cover,
                          errorBuilder: (context, error, stackTrace) {
...
Future<Map<String, dynamic>> _prepareFormData() async {
  ...
  return {
    ...
    'ownership': {
      ...
      'recyclingData':{
        'rawMaterialImageUrl': _rawMaterialImageUrlController.text.trim(),
        'endProductImageUrl': _endProductImageUrlController.text.trim(),
...
_selectedDate = DateTime.now();
    ...
    _endProductImageUrlController.clear();
    _rawMaterialImageUrlController.clear();
