...
//     // Send notification to admin users using the document ID
//     await _sendAdminNotification(docRef.id, imageUrl);
...
//   }
// }
// Update the _submitReport method to include ward and district in notification call
Future<void> _submitReport() async {
  if (!_formKey.currentState!.validate()) return;
...
// Future<void> _sendAdminNotification(String reportId, String imageUrl) async {
//   try {
//     // Get all admin users
...
//         // You'll need to create this Cloud Function
