...
import 'package:waste_manager/screens/auth_users/admin/ilemela/ilemela_map_page.dart';
import '/screens/mwanza/map_page.dart';
import '/screens/ilemela/ilemela_map_page.dart';
import '/screens/auth_users/login_page.dart';
// import 'auth_users/admin/mwanza/map_page.dart';
  ...
  void _navigateToMap(BuildContext context, String city) {
    if (city == 'Mwanza') {
      ...
      // Handle Ilemela navigation
        ...
        context,
        MaterialPageRoute(
          builder: (context) => const IlemelaMapPage(),
        ),
      );
    }
  }
