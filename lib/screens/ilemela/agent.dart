...
class AgentDashboardPage extends StatefulWidget {
  final User? user;
  const AgentDashboardPage({Key? key, required this.user}) : super(key: key);
...
class _AgentDashboardPageState extends State<AgentDashboardPage> {
  ...
  int _selectedIndex = 8; // For waste dealers tab
...
// Add these new variables in _AgentDashboardPageState
  ...
  Widget build(BuildContext context) {
    ...
    drawer: CustomDrawer(
      ...
      onItemTapped: _onItemTapped,
        user: _userRole == 'agent' ? widget.user : null, // Only pass user if they're a agent
