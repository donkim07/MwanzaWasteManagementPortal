...
// import 'ilemela_waste_dealersCollection_page.dart';
...
class WasteDealersListPage extends StatefulWidget {
  final User? user;
  const WasteDealersListPage({this.user});
      ...
      body: NestedScrollView(
        headerSliverBuilder: (context, innerBoxIsScrolled) => [
          ...
          SliverAppBar(
            ...
            //           context,
            //           MaterialPageRoute(
            //             builder: (context) => WasteDealerForm(),
            //           ),
            //         );
            //       },
            //     ),
...
Widget _buildDealersList() {
  return StreamBuilder<QuerySnapshot>(
    stream: _firestore.collection('ilemelaWasteDealersCollection').snapshots(),
